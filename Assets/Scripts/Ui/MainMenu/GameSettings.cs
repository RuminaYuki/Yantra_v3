...
/// <summary>
/// ชั้นที่ 1 — เก็บค่า setting ทั้งหมดไว้ที่เดียว
/// ไม่รู้จัก UI ไม่รู้จัก AudioMixer ไม่รู้จักอะไรทั้งนั้น
/// ใครอยากรู้ว่าค่าเปลี่ยนก็มา subscribe event เอง
/// </summary>
public static class GameSettings
{
    ...
    // ---------- Audio (0..1) ----------
    private static float _master, _bgm, _sfx, _voice;
    ...
    /// <summary>
    /// วิ่งอัตโนมัติก่อน scene แรกโหลด ไม่ต้องไปเรียกเองที่ไหน
    /// </summary>
